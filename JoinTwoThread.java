// Save this a JoinTwoThread.java
...
class JoinTwoThread {
  ...
  public static void main(String args[]) {
    ...
    Make_Thread object1 = new Make_Thread("First_Thread"); // this create the first new thread here !!!

    Make_Thread object2 = new Make_Thread("Second_Thread");// and here's the second one !!!
